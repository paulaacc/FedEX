...
function renderTableWithArrya($arrayDate){
    //Sample array data
    //Codes from Alex, he shall always be remembered for the contribution of codes below.
    $arrayData = [[
        'name'          => 'Alex',
        'age'           => 21,
        'gender'        => 'Male',
    ...
    foreach ($arrayData as $data) {
        ...
        for ($x = 0; $x < sizeof($keys); $x++) {
            echo "<th scope=\"col\">" . str_replace("_", " ", ucfirst($keys[$x])) . "</th>\n";
        }
        break;
    }
    echo "</tr>\n</thead>\n";
    foreach ($arrayData as $data) {
        ...
        echo "<tr scope=\"row\">\n";
        for ($x = 0; $x < sizeof($arrayData); $x++) {
            echo "<th>" . $arrayData[$x] . "</th>\n";
        }
        echo "</tr>\n";
    }
    echo "</table>\n";
